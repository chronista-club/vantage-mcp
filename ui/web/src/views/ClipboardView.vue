        ...
        <div class="page-header d-print-none">
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <h2 class="page-title">{{ t("clipboard.title") }}</h2>
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        ...
                        >
                            <IconTrash /> {{ t("clipboard.clearAll") }}
                        </button>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Error State -->
                                <div
                                    v-else-if="clipboardStore.error"
                                ...
                                <div v-else>
                                    <div
                                        v-for="(
                                            item, index
                                        ) in clipboardStore.history"
                                        :key="item.id"
                                        class="card mb-3 clipboard-item"
                                        :class="{
                                            'clipboard-item-latest':
                                                index === 0,
                                        }"
                                    >
                                        <div class="card-body">
