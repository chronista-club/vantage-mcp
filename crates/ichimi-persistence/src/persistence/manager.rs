...
impl ProcessInfoRecord {
    fn to_process_info(&self) -> ProcessInfo {
        ...
        ProcessInfo {
            ...
            name: self.process_id.clone(), // Use process_id as name for backward compatibility
            ...
            updated_at: Utc::now(),
            tags: Vec::new(),
            auto_start: self.auto_start_on_restore,
        }
    }
}
...
impl PersistenceManager {
    ...
    pub async fn load_all_processes(&self) -> Result<HashMap<String, ProcessInfo>, String> {
        ...
        for record in records {
            ...
            result.insert(info.process_id.clone(), info);
        }
